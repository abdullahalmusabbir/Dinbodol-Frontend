...
import type { CustomerProfile, VolunteerProfile, AdminProfile, UserRole } from "@/types";
...
interface RoleConfig {
    ...
    fields: ProfileField[];
    getMiniStats: (profile: AnyProfile) => { label: string; value: number | string }[];
    getAccountFields: (profile: AnyProfile) => { label: string; value: string; iconBg: string; iconColor: string }[];
    roleLabel: string;
...
const SvgIcon = ({ children, className }: { children: React.ReactNode; className: string }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">{children}</svg>
);

const IC = {
    user: (c: string) => <SvgIcon className={c}><path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" /></SvgIcon>,
    email: (c: string) => <SvgIcon className={c}><><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" /><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" /></></SvgIcon>,
    location: (c: string) => <SvgIcon className={c}><><path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" /></></SvgIcon>,
    calendar: (c: string) => <SvgIcon className={c}><><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" /></></SvgIcon>,
    edit: (c: string) => <SvgIcon className={c}><><path fillRule="evenodd" d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" clipRule="evenodd" /></></SvgIcon>,
    check: (c: string) => <SvgIcon className={c}><><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></></SvgIcon>,
    camera: (c: string) => <SvgIcon className={c}><><path fillRule="evenodd" d="M4 5a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2h-1.586a1 1 0 01-.707-.293l-1.121-1.121A2 2 0 0011.172 3H8.828a2 2 0 00-1.414.586L6.293 4.707A1 1 0 015.586 5H4zm6 9a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd" /></></SvgIcon>,
    info: (c: string) => <SvgIcon className={c}><><><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zm-1 4a1 1 0 00-1 1v4a1 1 0 102 0v-4a1 1 0 00-1-1z" clipRule="evenodd" /></></></SvgIcon>,
    warning: (c: string) => <SvgIcon className={c}><><><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0v-4a1 1 0 00-1-1z" clipRule="evenodd" /></></></SvgIcon>,
    checkCircle: (c: string) => <SvgIcon className={c}><><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></></SvgIcon>,
    lock: (c: string) => <SvgIcon className={c}><><><path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" /></></></SvgIcon>,
    key: (c: string) => <SvgIcon className={c}><><><path fillRule="evenodd" d="M18 8a6 6 0 01-7.743 5.743L10 14l-1 1-1 1H6v2H2v-4l4.257-4.257A6 6 0 1118 8zm-6-4a1 1 0 100 2 2 2 0 012 2 1 1 0 102 0 4 4 0 00-4-4z" clipRule="evenodd" /></></></SvgIcon>,
    lightbulb: (c: string) => <SvgIcon className={c}><><><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z" /></></></SvgIcon>,
};
...
const ROLE_CONFIGS: Record<UserRole, RoleConfig> = {
    customer: {
        ...
        fields: [
        { key: "full_name", label: "পুরো নাম", type: "text", icon: IC.user, iconBg: "bg-blue-50", iconColor: "text-blue-500" },
        { key: "email", label: "ইমেইল", type: "email", icon: IC.email, iconBg: "bg-purple-50", iconColor: "text-purple-500" },
        { key: "address", label: "এলাকা", type: "text", icon: IC.location, iconBg: "bg-amber-50", iconColor: "text-amber-500" },
        { key: "date_of_birth", label: "জন্মদিন", type: "date", icon: IC.calendar, iconBg: "bg-rose-50", iconColor: "text-rose-500" },
        ],
        getMiniStats: () => [
        { label: "মোট রিপোর্ট", value: 0 },
        { label: "সমাধান", value: 0 },
        ],
        getAccountFields: (profile) => [
        { label: "ইউজারনেম", value: profile.user.username, iconBg: "bg-indigo-50", iconColor: "text-indigo-500" },
        { label: "ইমেইল", value: profile.user.email || "যুক্ত হয়নি", iconBg: "bg-purple-50", iconColor: "text-purple-500" },
        { label: "জন্মতারিখ", value: profile.date_of_birth ? new Date(profile.date_of_birth).toLocaleDateString("bn-BD", { day: "numeric", month: "long", year: "numeric" }) : "যুক্ত হয়নি", iconBg: "bg-rose-50", iconColor: "text-rose-500" },
        { label: "এলাকা", value: profile.address || "যুক্ত হয়নি", iconBg: "bg-amber-50", iconColor: "text-amber-500" },
        ],
        roleLabel: "কাস্টমার",
    ...
    volunteer: {
        ...
        { key: "email", label: "ইমেইল", type: "email", icon: IC.email, iconBg: "bg-purple-50", iconColor: "text-purple-500" },
        { key: "address", label: "এলাকা", type: "text", icon: IC.location, iconBg: "bg-amber-50", iconColor: "text-amber-500" },
        { key: "skills", label: "দক্ষতা", type: "textarea", icon: IC.user, iconBg: "bg-emerald-50", iconColor: "text-emerald-500", placeholder: "আপনার দক্ষতাগুলো লিখুন" },
        { key: "availability", label: "উপলব্ধতা", type: "text", icon: IC.calendar, iconBg: "bg-indigo-50", iconColor: "text-indigo-500", placeholder: "যেমন: সপ্তাহান্তে, দিনPron" },
        ],
        getMiniStats: (profile) => [
        ...
        { label: "ইমেইল", value: profile.user.email || "যুক্ত হয়নি", iconBg: "bg-purple-50", iconColor: "text-purple-500" },
        { label: "এলাকা", value: profile.address || "যুক্ত হয়নি", iconBg: "bg-amber-50", iconColor: "text-amber-500" },
        { label: "যোগদান", value: profile.joined_at ? new Date(profile.joined_at).toLocaleDateString("bn-BD", { day: "numeric", month: "long", year: "numeric" }) : "—", iconBg: "bg-emerald-50", iconColor: "text-emerald-500" },
        ],
    ...
    admin: {
        ...
        getMiniStats: (profile) => [
        { label: "যোগদান", value: profile.joined_at ? new Date(profile.joined_at).toLocaleDateString("bn-BD", { day: "numeric", month: "long", year: "numeric" }) : "—" },
        ],
        getAccountFields: (profile) => [
        { label: "ইউজারনেম", value: profile.user.username, iconBg: "bg-indigo-50", iconColor: "text-indigo-500" },
        { label: "ইমেইল", value: profile.user.email || "যুক্ত হয়নি", iconBg: "bg-purple-50", iconColor: "text-purple-500" },
...
export default function ProfileC() {
    ...
    const config: RoleConfig | null = role ? ROLE_CONFIGS[role] : null;
    ...
    const avatarInitial =
        (profile?.user.first_name?.[0] || profile?.user.username?.[0] || "ব").toUpperCase();

    const miniStats = config ? config.getMiniStats(profile as AnyProfile) : [];
    const accountFields = config ? config.getAccountFields(profile as AnyProfile) : [];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm transition-all duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)]">
                ...
                {config?.fields.map((field) => {
                    ...
                    const value = isFullName ? `${form.first_name} ${form.last_name}`.trim() : form[field.key as keyof typeof form];
